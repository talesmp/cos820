...
class SelecaoPescResourceIT {
    ...
    private static final String DEFAULT_ESTRANGEIRO_SIM_NAO = "AAAAAAAAAA";
    private static final String UPDATED_ESTRANGEIRO_SIM_NAO = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_PROFICIENCIA_INGLES_NOTA = "AAAAAAAAAA";
    private static final String UPDATED_PROFICIENCIA_INGLES_NOTA = "BBBBBBBBBB";
    ...
    public static SelecaoPesc createEntity(EntityManager em) {
        SelecaoPesc selecaoPesc = new SelecaoPesc()
            ...
            .estrangeiroSimNao(DEFAULT_ESTRANGEIRO_SIM_NAO)
    ...
    public static SelecaoPesc createUpdatedEntity(EntityManager em) {
        SelecaoPesc selecaoPesc = new SelecaoPesc()
            ...
            .estrangeiroSimNao(UPDATED_ESTRANGEIRO_SIM_NAO)
    ...
    void getAllSelecaoPescs() throws Exception {
        ...
        restSelecaoPescMockMvc
            ...
            .andExpect(jsonPath("$.[*].estrangeiroSimNao").value(hasItem(DEFAULT_ESTRANGEIRO_SIM_NAO)))
            ...
            .andExpect(jsonPath("$.[*].proficienciaInglesNota").value(hasItem(DEFAULT_PROFICIENCIA_INGLES_NOTA)))
    ...
    void getSelecaoPesc() throws Exception {
        ...
        restSelecaoPescMockMvc
            ...
            .andExpect(jsonPath("$.estrangeiroSimNao").value(DEFAULT_ESTRANGEIRO_SIM_NAO))
            ...
            .andExpect(jsonPath("$.proficienciaInglesNota").value(DEFAULT_PROFICIENCIA_INGLES_NOTA))
