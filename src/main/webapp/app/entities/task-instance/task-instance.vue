      ...
      <table class="table table-striped" aria-describedby="taskInstances">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.createTime')">Create Time</span></th>
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.dueDate')">Due Date</span></th>
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.startTime')">Start Time</span></th>
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.endTime')">End Time</span></th>
            ...
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.executionId')">Execution Id</span></th>
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.taskDefinitionKey')">Task Definition Key</span></th>
            <th scope="row"><span v-text="$t('selecaoPescApp.taskInstance.suspended')">Suspended</span></th>
