...
public interface TaskUserInformarOutrasInformacoesMapper {
    ...
    @Mapping(target = "documentoCpfPassaporte", source = "documentoCpfPassaporte")
    @Mapping(target = "proficienciaInglesTipoTeste", source = "proficienciaInglesTipoTeste")
    @Mapping(target = "proficienciaInglesNota", source = "proficienciaInglesNota")
